...
import Spectrogram from '../../../components/Spectrogram/SpectrogramView';
import AudioControls from '../Audio/Controls';
import { getEnv } from 'mobx-state-tree';

const HtxSpecAudioView = ({ store, item }) => {
...
export const HtxSpecAudio = inject('store')(observer(HtxSpecAudioView));
